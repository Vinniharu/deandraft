const pressReleases = [
  {
    ...
    categories: ["News", "Press Release", "Uncategorized"],
    summary:
      "DEAN Initiative criticizes the Federal Government's introduction of 15 skill acquisition courses, arguing they don't address 21st-century competencies and demanding more forward-thinking educational reforms.",
    content: `Breaking news of the Federal Government introducing 15 skill acquisition courses into the curriculum for Primary and Junior Secondary schools in Nigeria raises more concern than applause. While on the surface, this initiative seems like progress, it only scratches the surface of what is truly needed for education transformation in this country.
...
We demand more forward-thinking strategies and innovative educational reforms that align with global standards and the aspirations of Nigerian youth!`,
  },
  {
    id: 4,
    title:
      "Monitoring Internally Generated Revenue (IGR) At The Local Government Level Using The Open LGA Platform",
    date: "October 14, 2024",
    authors: ["Dorcas Mokikan", "Michael Adigam"],
    categories: ["Governance", "News", "OGP local", "Press Release"],
    summary:
...
Information technology should be introduced so as to create a comprehensive database for tracking internally generated revenue at the local government level. The Open LGA Platform is an important platform for this process.`,
  },
  {
    ...
    summary:
      "Duplicate announcement of Doreen Mennom Oho's selection for the Climate Democracy Accelerator Program, emphasizing the competitive nature and $10,000 implementation grant.",
    content: `DEAN Initiative is excited to announce that our Technical Programs Lead Doreen Mennom Oho has been selected for the 2024/2025 Climate Democracy Accelerator Program, following an extremely competitive application process that attracted hundreds of applications from across the globe, only 15 participants were selected, representing 12 countries.

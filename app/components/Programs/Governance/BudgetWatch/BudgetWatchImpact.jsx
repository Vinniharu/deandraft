...
export default function BudgetWatchImpact() {
    ...
    const impactData = [
        {
            stat: "6+",
            label: "Area Councils",
            description: "Active engagement in FCT area councils"
        },
        {
            stat: "1000+",
            label: "Citizens Engaged",
            description: "Direct participation in budget processes"
        },
        {
            stat: "30+",
            label: "Community Leaders",
            description: "Trained in budget monitoring"
        },
        {
            stat: "12+",
            label: "Policy Changes",
            description: "Successful advocacy outcomes"
        }
    ];
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center mb-16">
                            ...
                            <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
                                Our initiative has transformed local governance through enhanced budget transparency and citizen engagement
                            </p>
                        </div>

                        {/* Static version of Impact Grid */}
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
                            {/* Static version of your content */}
                            {/* Copy your existing JSX but remove all motion.* components and animation props */}
                        </div>

                        {/* Static version of Get Involved Section */}
                        <div className="bg-gradient-to-r from-[#1a2747] to-[#2a3a5d] rounded-xl shadow-xl p-8 md:p-10 text-white mt-12">
                            {/* Copy your existing JSX but remove all motion.* components and animation props */}
                        </div>
                    </div>
                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <p className="text-gray-700">
                                        Successfully facilitated budget co-creation processes in multiple area councils.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <p className="text-gray-700">
                                        Trained over 1,000 community members in budget monitoring and tracking.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <p className="text-gray-700">
                                        Established community-based budget monitoring committees in target areas.
                                    </p>
                                </motion.div>
                            </div>
                        </motion.div>
                    ...
                    >
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-300 max-w-2xl mx-auto">
                                Join our mission to transform budget processes by getting involved in the #BudgetWatch initiative
                            </p>
                        </div>
                        
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            {[
                                { title: "Volunteer", icon: "🙋‍♀️", description: "Join our team of budget monitors" },
                                { title: "Partner", icon: "🤝", description: "Collaborate on transparency initiatives" },
                                { title: "Support", icon: "❤️", description: "Contribute resources to our programs" },
                                { title: "Advocate", icon: "📢", description: "Help spread awareness about budget transparency" }
                            ].map((item, index) => (
                                <motion.div
                                    key={index}

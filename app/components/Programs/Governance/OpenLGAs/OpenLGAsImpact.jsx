...
export default function OpenLGAsImpact() {
    ...
    const impactData = [
        {
            stat: "6+",
            label: "Area Councils",
            description: "Active engagement across FCT area councils"
        },
        {
            stat: "1000+",
            label: "Citizens Engaged",
            description: "Direct participation in town hall meetings"
        },
        {
            stat: "30+",
            label: "Officials Trained",
            description: "Capacity building for local government staff"
        },
        {
            stat: "12+",
            label: "Policy Reforms",
            description: "Successful advocacy for governance reforms"
        }
    ];
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
                            Our initiative has transformed local governance through enhanced transparency and citizen engagement
                        </p>
                    </motion.div>
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <p className="text-gray-700">
                                        Successfully facilitated the induction of AMAC into the OGP Global membership.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <p className="text-gray-700">
                                        Coordinated the onboarding of Local Parliament members from all FCT Area Councils into OGP Local.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <p className="text-gray-700">
                                        Hosted the first-ever Local Government Accountability Award ceremony.
                                    </p>
                                </motion.div>
                            </div>
                        </motion.div>
                    ...
                    >
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-300 max-w-2xl mx-auto">
                                Join our mission to transform local governance by getting involved in the #OpenLGAs initiative
                            </p>
                        </div>
                        
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            {[
                                { title: "Volunteer", icon: "🙋‍♀️", description: "Join our team of local governance advocates" },
                                { title: "Partner", icon: "🤝", description: "Collaborate with us on transparency initiatives" },
                                { title: "Support", icon: "❤️", description: "Contribute resources to our programs" },
                                { title: "Advocate", icon: "📢", description: "Help spread awareness about local governance" }
                            ].map((item, index) => (
                                <motion.div
                                    key={index}

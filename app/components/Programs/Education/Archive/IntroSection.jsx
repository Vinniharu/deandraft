                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-gray-700 leading-relaxed text-lg mb-6">
                                At DEAN Initiative, we champion innovative, youth-driven education programs that bridge knowledge gaps, foster creativity, and empower communities. This archive highlights key initiatives that demonstrate our dedication to inclusive, sustainable, and impactful learning across Nigeria.
                            </p>
                            
                            <div className="flex flex-wrap gap-3 mt-8">
                                <span className="inline-block px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">Innovative Learning</span>
                                <span className="inline-block px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-medium">Youth Development</span>
                                <span className="inline-block px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">Community Impact</span>
                                <span className="inline-block px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-medium">Sustainable Education</span>
                            </div>
                        </div>
                    </motion.div>
                </div>

...
export default function SDGsObjectives() {
    ...
    const objectives = [
        {
            title: "SDG Education Integration",
            description: "Integrate SDG education seamlessly into school curricula through innovative teaching methods and resources.",
            icon: "📚",
            color: "blue"
        },
        {
            title: "Student Empowerment",
            description: "Empower students to become active agents of change in their communities through practical SDG projects.",
            icon: "💪",
            color: "red"
        },
        {
            title: "Teacher Development",
            description: "Enhance teachers' capacity to deliver engaging SDG-focused lessons and activities.",
            icon: "👩‍🏫",
            color: "blue"
        },
        {
            title: "Community Impact",
            description: "Create lasting positive impact in local communities through student-led SDG initiatives.",
            icon: "🌍",
            color: "red"
        },
        {
            title: "Global Connection",
            description: "Connect Nigerian students with the global sustainability movement and international peers.",
            icon: "🤝",
            color: "blue"
        }
    ];
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
                            Our carefully designed objectives ensure that the SDGs Activation Program creates meaningful impact in schools and communities
                        </p>
                    </motion.div>

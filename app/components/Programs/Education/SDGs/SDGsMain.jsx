                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
                            Empowering students to become active participants in achieving the Global Goals
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-lg text-center text-gray-100 max-w-4xl mx-auto italic">
                            "We envision a Nigeria where every student understands, embraces, and actively contributes to achieving the Sustainable Development Goals, creating positive change in their communities."
                        </p>
                    </motion.div>
                </div>
            </div>

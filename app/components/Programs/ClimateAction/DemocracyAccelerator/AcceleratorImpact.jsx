...
export default function AcceleratorImpact() {
  ...
  const impactData = [
    {
      stat: "50+",
      label: "Communities",
      description: "Engaged in democratic climate action initiatives",
    },
    {
      stat: "1000+",
      label: "Participants",
      description: "Trained in democratic climate governance",
    },
    {
      stat: "25",
      label: "Projects",
      description: "Community-led climate initiatives launched",
    },
    {
      stat: "15",
      label: "Partnerships",
      description: "With local governments and organizations",
    },
  ];
  ...
  const achievements = [
    {
      title: "Policy Impact",
      description:
        "Influenced climate policies through participatory processes and community engagement",
    },
    {
      title: "Community Empowerment",
      description:
        "Strengthened local capacity for democratic climate action and decision-making",
    },
    {
      title: "Innovation Hub",
      description:
        "Created platforms for sharing democratic climate solutions across regions",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div className="text-center mb-16" variants={headerVariants}>
            ...
            <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
              Transforming communities through democratic climate action
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="mb-6 max-w-2xl mx-auto">
              Join us in building a more democratic and sustainable future.
              Whether you're a community leader, organization, or concerned
              citizen, there are many ways to participate in our program.
            </p>

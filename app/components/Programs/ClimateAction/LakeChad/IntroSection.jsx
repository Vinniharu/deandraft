                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-gray-800">About the Fellowship</h2>
                            </div>
                            ...
                            <div className="mt-8 bg-red-50 rounded-xl p-6 border-l-4 border-red-500">
                                <h3 className="text-xl font-semibold text-red-800 mb-3">Why It Matters</h3>
                                <p className="text-gray-700 leading-relaxed">
                                    The Lake Chad region faces severe challenges—shrinking water bodies, rising insecurity, gender-based violence, and declining livelihoods. Young people, particularly women, are disproportionately affected, yet often excluded from decision-making. This fellowship shifts that narrative by centering youth voices and leadership in climate action.
                                </p>
                            </div>
                            
                            <div className="flex flex-wrap gap-3 mt-8">
                                <span className="inline-block px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">Climate Justice</span>
                                <span className="inline-block px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-medium">Youth Leadership</span>
                                <span className="inline-block px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">Lake Chad Basin</span>
                                <span className="inline-block px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-medium">Resilience Building</span>
                            </div>
                        </div>
                    </motion.div>
                </div>

...
export default function NationalActionObjectives() {
    ...
    const objectives = [
        ...
        },
        {
            ...
            description: "Bringing together diverse stakeholders to create collective impact through coordinated action on the SDGs.",
            icon: "🤝",
            color: "red"
        },
        {
            title: "Knowledge Sharing",
            description: "Creating platforms for sharing best practices, lessons learned, and success stories across regions.",
            icon: "📚",
            color: "blue"
        }
    ];
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
                            Building a nationwide movement for sustainable development through targeted objectives
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-gray-600">
                            Our program takes a holistic approach to sustainable development, integrating the SDGs with local contexts and priorities to ensure that global goals translate into meaningful local action. Through this integrated strategy, we create lasting impact that resonates from community to national levels.
                        </p>
                    </motion.div>
                </div>
            </div>

...
export default function NationalActionImpact() {
  ...
  const impactData = [
    {
      stat: "36+",
      label: "States",
      description: "Active participation across Nigeria",
    },
    {
      stat: "5000+",
      label: "Students",
      description: "Engaged in SDG activities",
    },
    {
      stat: "200+",
      label: "Schools",
      description: "Participating nationwide",
    },
    {
      stat: "50+",
      label: "Partners",
      description: "Supporting the initiative",
    },
  ];
  ...
  const achievements = [
    {
      ...
      description:
        "Successfully activated SDG champions in all six geopolitical zones of Nigeria",
    },
    {
      title: "Youth Empowerment",
      description:
        "Created platforms for youth to lead sustainable development initiatives",
    },
    {
      title: "Policy Influence",
      description:
        "Contributed to local and state-level SDG policy formulation",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div className="text-center mb-16" variants={headerVariants}>
            ...
            <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
              Transforming communities through nationwide SDG action
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="mb-6 max-w-2xl mx-auto">
              Join us in building a more sustainable future. Whether you're a
              school, organization, or concerned citizen, there are many ways to
              participate in the National Action Day movement.
            </p>

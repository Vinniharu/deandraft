  ...
  const impactData = [
    {
      ...
      description: "Influential leaders trained across multiple regions"
    },
    {
      stat: "25+",
      label: "Training Sessions",
      description: "On election data analysis and civic advocacy"
    },
    {
      stat: "15+",
      label: "Campaigns",
      description: "Grassroots campaigns against electoral malpractices"
    },
    {
      stat: "10K+",
      label: "Citizens Reached",
      description: "Through civic tech tools and advocacy"
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
              Transforming citizen participation and electoral integrity across Nigeria
            </p>
          </div>
          ...
          >
            ...
            <p className="mb-6 max-w-2xl mx-auto">
              Join us in strengthening Nigeria's democracy through citizen-led advocacy. Whether you're a community leader, organization, or concerned citizen, there are many ways to contribute to our mission.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="mailto:info@dean.org.ng">

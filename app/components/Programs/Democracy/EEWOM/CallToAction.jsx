    ...
    <section className="py-16 md:py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-[var(--dean-blue)] to-[var(--dean-red)] bg-clip-text text-transparent">Join the Movement for Electoral Integrity</h2>
            <p className="text-lg text-gray-700 mb-10 max-w-3xl mx-auto">
              The Election EyeWitness Observation Mission is a powerful platform for citizens, especially youth, 
              to actively participate in safeguarding Nigeria's democratic processes. Be part of our initiative 
              to promote transparent, free, and fair elections.
            </p>

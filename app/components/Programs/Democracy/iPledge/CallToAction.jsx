  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-r from-[var(--dean-blue)] to-[var(--dean-red)] text-white relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Join The iPledge2Vote Movement</h2>
          <p className="text-lg text-white/90 mb-10">
            Together, we can strengthen Nigeria's democracy by increasing voter participation and holding our elected officials accountable.
          </p>

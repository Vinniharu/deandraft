    ...
    const actions = [
        {
            title: "Volunteer",
            icon: "🙋‍♀️",
            description: "Join our volunteer network and contribute your skills and time to our impactful initiatives across Africa.",
            link: "/volunteer",
            color: "blue"
        },
        {
            title: "Donate",
            icon: "❤️",
            description: "Support our youth-driven programs with a donation that helps create sustainable futures and empower communities.",
            link: "/donate",
            color: "red"
        },
        {
            ...
            icon: "🤝",
            description: "Collaborate with DEAN Initiative to create meaningful impact through strategic partnerships and joint initiatives.",
            link: "/partner",
            color: "blue"
        },
    ];
                ...
                <div ref={contentRef} className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
                            Be part of our mission to empower youth, champion sustainable development, and create positive change across Africa
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        {actions.map((action, index) => (
                            ...
                            >
                                <div className="p-8">
                                    <div className={`w-16 h-16 mb-6 rounded-full bg-[var(--dean-${action.color})]/10 flex items-center justify-center text-3xl`}>
                                        {action.icon}
                                    </div>
                                    <h3 className="text-xl font-bold text-[var(--dean-blue)] mb-3">{action.title}</h3>
                                    <p className="text-gray-600 mb-6">{action.description}</p>
                                    <Link href={action.link}>
                                        <span className={`inline-flex items-center text-white bg-[var(--dean-${action.color})] hover:bg-[var(--dean-${action.color})]/90 py-2 px-4 rounded-md text-sm transition-colors duration-200`}>
                                            Get Started
                                            <svg

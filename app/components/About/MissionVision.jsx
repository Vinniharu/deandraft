        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[var(--dean-blue)]/90 to-transparent"></div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-700">
                At DEAN, our mission is fueled by a commitment to empowering youth as agents of change who lead initiatives that transform their communities and society at large.
              </p>
              <div className="pt-4">
                <motion.div 
          ...
          <motion.div
            ref={visionRef}
            className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center md:mt-24"
            initial="hidden"
          ...
          >
            ...
            <div className="space-y-6 md:order-last">
              ...
              <p className="text-gray-700">
                This vision reflects our belief in the power of young people to redefine the future through leadership, creativity, and inclusivity.
              </p>
              <div className="pt-4">
                <motion.div 
            ...
            >
              <Image
                ...
                className="transition-transform duration-700 hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[var(--dean-red)]/90 to-transparent"></div>
              <div className="absolute bottom-0 left-0 p-6">
          ...
          >
            <p className="text-lg text-gray-700 italic mb-6">
              "We believe in the power of young people to create lasting change for a better world."
            </p>
            <motion.div

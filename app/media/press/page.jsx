...
export default function Press() {
  ...
  const allCategories = [
    "All",
    ...new Set(pressReleases.flatMap((pr) => pr.categories)),
  ];
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="bg-[url('/hero/hero-3.jpg')] bg-cover bg-center bg-no-repeat">
        <div className="bg-gradient-to-r from-[var(--dean-blue)]/60 via-[var(--dean-blue)]/60 to-[var(--dean-red)]/60 text-white h-[50vh]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="text-center">
              <h1 className="text-5xl font-bold mb-6">Press Releases</h1>
              <p className="text-2xl text-blue-100 max-w-3xl mx-auto">
                Stay updated with our latest news and announcements about our
                initiatives, achievements, and contributions to the community.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {filteredReleases.map((pressRelease) => (
            ...
            >
              <Link
                href={`/media/press/${pressRelease.id}`}

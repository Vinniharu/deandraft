...
const blogPosts = [
  ...
  },
  {
    ...
    content: "CenterLSD, in collaboration with DEAN Initiative, organized a Peer Learning Session to promote collaboration..."
  },
  {
    ...
    content: "To deepen governance reforms at the grassroots, the Open Government Partnership-Local (OGP-Local) hosted a two-day Scorecard and Peer Learning Session in Keffi..."
  }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-2xl text-blue-100 max-w-3xl mx-auto">
              Stay informed about our initiatives, achievements, and impact in education and development.
            </p>
          </div>
        </div>
      </div>
